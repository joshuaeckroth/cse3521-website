...
help. In particular, you'll need to use ~assertz~ and ~retract~ and
~retractall~ (21:30 mark in the video). *Write this in a Prolog source
file (~hw6.pl~ maybe), and test your code. Submit the source file so
the grader can also test your code.*
