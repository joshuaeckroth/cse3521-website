...
[Note, I've since read that this understanding of the Turing Test, in
which the machine is trying to convince the judge it is a human, is a
"neutered" version. Originally, it is said, Turing expected the
machine to be tasked with convincing the judge that it is a woman,
which is an easier task since the questions from the judge would not
revolve around what it means to be a human. Read "[[http://www.aaai.org/ojs/index.php/aimagazine/article/view/2106/1996][The Voice of the
Turtle: Whatever Happened to AI?]]" (PDF) by Lenat (2008).]
...
More about "Winograd Schemas" can be found in the paper "[[http://www.aaai.org/ocs/index.php/KR/KR12/paper/download/4492/4924][The Winograd
Schema Challenge]]" (PDF) by Levesque, Davis, and Morgenstern (2012).
