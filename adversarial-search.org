...
way you can fly without flapping your wings." --- Bruce Weber, "[[http://www.rci.rutgers.edu/~cfs/472_html/Intro/NYT_Intro/ChessMatch/MeanChessPlaying.html][Mean
Chess-Playing Computer Tears at Meaning of Thought]]," The New York
Times, Feb 19, 1996
#+END_QUOTE
...
Check out the [[./images/ttt-alphabeta-example.png][final search graph]] of another tic-tac-toe example, this
time with alpha-beta pruning. For comparison, [[./images/ttt-minimax-example-2.png][this is the search graph
