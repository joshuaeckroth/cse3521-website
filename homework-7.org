...
Execute the k-nearest neighbor algorithm by hand on the centroids
found from task 1 (or make up two random centroids if you did not
finish task 1). Use $k = 2$. Classify the data point: $<1, 3, 0, 2>$.
