...
[humanly/rationally]. In the first dimension, acting vs. thinking, the
idea is that an artifact that acts a certain way will exhibit the
...
told." Even machines that "learn" are only able to learn what they are
programmed to learn, no more, no less.
...
However, true intelligence may not be a property of individuals but
rather an emergent social or collective phenomenon. And AI systems may
